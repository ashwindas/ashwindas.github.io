...
export default function RootLayout({
  ...
  const cspContent = isDevelopment
    ...
    : "default-src https: 'self'; script-src https: 'self' 'unsafe-inline'; style-src https: 'self' 'unsafe-inline'; img-src https: 'self' data:; font-src https: 'self' data:; connect-src https: 'self'; upgrade-insecure-requests;";
